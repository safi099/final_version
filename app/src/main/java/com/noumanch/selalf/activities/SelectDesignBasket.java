...
public class SelectDesignBasket extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(SelectDesignBasket.this));
...
/*        add_address.setOnClickListener(new View.OnClickListener() {
         ...
         adapter = new SimpleStringRecyclerViewAdapter(SelectDesignBasket.this,baskets);
    ...
    /*    final ProgressDialog progressDialog = new ProgressDialog(SelectDesignBasket.this) ;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(SelectDesignBasket.this, "Error due to JSON ", Toast.LENGTH_SHORT).show();
                        }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        if (spinKitView!=null)
                            spinKitView.setVisibility(View.GONE);
                        Toast.makeText(SelectDesignBasket.this,"Internet is Not working correctly",Toast.LENGTH_SHORT).show();
        ...
        public void onBindViewHolder(final SimpleStringRecyclerViewAdapter.ItemViewHolder holder, final int position) {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    ArrayList<String> arrayList = mValues.get(position).getImage();
                        p.setImage(arrayList);


                    Database database = new Database(holder.image.getContext());
                        p.setGiftText("");
                        int i =database.addProduct(p,0);
                        Log.wtf("test", "onClick: "+p.toString() );
                        database.close();
                        if (i!=-1){
                            //add the product to cart
                            holder.itemView.getContext().startActivity(new Intent(holder.itemView.getContext(),SelectDesignBasketChooseCategory.class));
                            ((Activity)holder.mView.getContext()).finish();
                            Toast.makeText(holder.image.getContext(), "Product added to cart", Toast.LENGTH_SHORT).show();
...
// Add or remove notification for each item
        if (new Database(SelectDesignBasket.this).getProducts()!=null){
            int v  =new Database(SelectDesignBasket.this).getProducts().size();
            if (v!=0){
