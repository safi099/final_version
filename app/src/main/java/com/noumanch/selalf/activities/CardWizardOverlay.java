...
public class CardWizardOverlay extends AppCompatActivity {
    ...
    private String about_title_array[] = {
            "Order a basket",
            "Write a note with the basket",
            "We will deliver the basket"
    };
    ...
    private int about_images_array[] = {
            R.drawable.order_a_basket,
            R.drawable.write_a_note_with_the_basket,
            R.drawable.we_will_deliver_the_basket
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_card_wizard_overlay);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (current < MAX_STEP) {
                    ...
                    startActivity(new Intent(CardWizardOverlay.this, First.class));
                    finish();
                }
            }
        });
