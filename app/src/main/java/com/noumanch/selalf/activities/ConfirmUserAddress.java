...
public class ConfirmUserAddress extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirm_addresses);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(ConfirmUserAddress.this));

        add_address.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ConfirmUserAddress.this,AddAddresses.class);
                i.putExtra("customerId",""+StaticVariables.getUserId(ConfirmUserAddress.this));
                startActivity(i);
                finish();
            }
        });
         adapter = new SimpleStringRecyclerViewAdapter(ConfirmUserAddress.this,addressesArrayList);
        recyclerView.setAdapter(adapter);

if (StaticVariables.getUserId(ConfirmUserAddress.this)!=null){
    doTask(""+StaticVariables.getUserId(ConfirmUserAddress.this));
...
next_button.setOnClickListener(new View.OnClickListener() {
    @Override
    public void onClick(View view) {
        Intent i = new Intent(ConfirmUserAddress.this,SelectDevlieryType.class);
        startActivity(i);
    }
});
...
/*
        final ProgressDialog progressDialog = new ProgressDialog(ConfirmUserAddress.this) ;
...
*/
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                    ...
                    public void onResponse(String response) {
                        Log.i("RESPONSE",""+response);
                            ...
                            try {
                                ...
                                if (array1.length() == 0) {
                                    Toast.makeText(ConfirmUserAddress.this, "No Address found", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(ConfirmUserAddress.this, "Error due to JSON "+ex.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        spinKitView.setVisibility(View.GONE);
                        Toast.makeText(ConfirmUserAddress.this,"Internet is Not working correctly",Toast.LENGTH_SHORT).show();
    ...
    public static class SimpleStringRecyclerViewAdapter
        ...
        public class ItemViewHolder extends RecyclerView.ViewHolder {
            ...
            public final LinearLayout layout_update;
            public final View layout_update_view;
            ...
            public ItemViewHolder(View view) {
                ...
                layout_update_view =  view.findViewById(R.id.layout_update_view);
        ...
        public SimpleStringRecyclerViewAdapter.ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_select_addrss, parent, false);
        ...
        public void onBindViewHolder(final SimpleStringRecyclerViewAdapter.ItemViewHolder holder, final int position) {
            try {
                holder.layout_update.setVisibility(View.GONE);
                holder.layout_update_view.setVisibility(View.GONE);
...
// Add or remove notification for each item
        if (new Database(ConfirmUserAddress.this).getProducts()!=null){
            int v  =new Database(ConfirmUserAddress.this).getProducts().size();
            if (v!=0){
